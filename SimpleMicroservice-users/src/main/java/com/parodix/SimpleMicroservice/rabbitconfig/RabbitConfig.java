...
import com.parodix.SimpleMicroservice.rabbitreceiver.RabbitReceiver;
...
public class RabbitConfig {
  ...
  private static final String EXCHANGE_TOPIC = "credit-user-topic";
  private static final String QUEUE_NAME = "credit-user-queue";
  private static final String PATH_KEY = "credit-user-path-key";
